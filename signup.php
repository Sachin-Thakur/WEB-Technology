...
$usertype=$_POST['usertype'];
 ...
 $sql ="INSERT INTO `resgistration`(`name`, `email`, `password`, `register`, `usertype`) VALUES ('$name','$email','$password','$register','$usertype')";

  if(@mysqli_query($con,$sql))
  {
    echo "row inserted";
  }
echo "user is $name $email, $password,$register, $usertype";
?>
